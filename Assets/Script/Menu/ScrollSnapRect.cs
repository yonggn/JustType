...
public class ScrollSnapRect  : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    public LevelProgress levelAuSource;
    //------------------------------------------------------------------------
    void Start() {
    ...
    private void SetPageSelection(int aPageIndex) {
        ...
        levelAuSource.audioSource.clip = levelAuSource.level[aPageIndex].audioClip;
        //UniBpmAnalyzer.AnalyzeBpm(levelAuSource.audioSource.clip);
        levelAuSource.audioSource.Play();
    }
